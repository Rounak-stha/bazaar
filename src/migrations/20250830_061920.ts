...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_orders_shipping_address_province" AS ENUM('Koshi', 'Madhesh', 'Bagmati', 'Gandaki', 'Lumbini', 'Karnali', 'Sudhurpaschim');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('pending', 'paid', 'shipped', 'completed', 'cancelled');
  CREATE TYPE "public"."enum_orders_payment_status" AS ENUM('unpaid', 'paid', 'refunded', 'failed', 'cancelled');
  CREATE TYPE "public"."enum_product_options_type" AS ENUM('generic', 'color', 'fabric');
  CREATE TYPE "public"."enum_transactions_status" AS ENUM('pending', 'success', 'failed', 'refunded', 'expired', 'user_cancelled');
  CREATE TYPE "public"."enum_addresses_province" AS ENUM('Koshi', 'Madhesh', 'Bagmati', 'Gandaki', 'Lumbini', 'Karnali', 'Sudhurpaschim');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_users_roles" AS ENUM('super-admin', 'shop-admin');
  ...
  CREATE TYPE "public"."enum_shop_settings_available_currencies" AS ENUM('NPR');
  ...
  CREATE TABLE "products_rels" (
  	...
  	"media_id" integer,
  	"product_option_values_id" integer
  );
  ...
  CREATE TABLE "_products_v_version_variants_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"type_id" integer,
  ...
  CREATE TABLE "orders_items_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "orders" (
  	...
  	"shop_id" integer,
  	"customer_id" integer,
  	"shipping_address_address_id" integer,
  	"shipping_address_full_name" varchar NOT NULL,
  	"shipping_address_province" "enum_orders_shipping_address_province" NOT NULL,
  ...
  CREATE TABLE "product_options" (
  	...
  	"type" "enum_product_options_type" DEFAULT 'generic' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "product_option_values" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"_productoptionvalues_values_order" varchar,
  	"shop_id" integer,
  	"product_option_type_id" integer NOT NULL,
  	"name" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "addresses" (
  	...
  	"province" "enum_addresses_province" NOT NULL,
  ...
  CREATE TABLE "payment_providers" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"shop_id" integer,
  	"khalti_enabled" boolean DEFAULT false NOT NULL,
  	"khalti_config_live_secret_key" varchar,
  	"khalti_config_live_public_key" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"header_id" integer,
  	"footer_id" integer,
  	"payment_providers_id" integer,
  	"shop_layout_id" integer,
  	"shop_settings_id" integer,
  ...
  ALTER TABLE "products_options" ADD CONSTRAINT "products_options_type_id_product_options_id_fk" FOREIGN KEY ("type_id") REFERENCES "public"."product_options"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "products_variants_options" ADD CONSTRAINT "products_variants_options_type_id_product_options_id_fk" FOREIGN KEY ("type_id") REFERENCES "public"."product_options"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "products_variants_options" ADD CONSTRAINT "products_variants_options_value_id_product_option_values_id_fk" FOREIGN KEY ("value_id") REFERENCES "public"."product_option_values"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "products_categories" ADD CONSTRAINT "products_categories_category_id_product_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."product_categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "products_rels" ADD CONSTRAINT "products_rels_product_option_values_fk" FOREIGN KEY ("product_option_values_id") REFERENCES "public"."product_option_values"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_version_options" ADD CONSTRAINT "_products_v_version_options_type_id_product_options_id_fk" FOREIGN KEY ("type_id") REFERENCES "public"."product_options"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_version_variants_options" ADD CONSTRAINT "_products_v_version_variants_options_type_id_product_options_id_fk" FOREIGN KEY ("type_id") REFERENCES "public"."product_options"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_version_variants_options" ADD CONSTRAINT "_products_v_version_variants_options_value_id_product_option_values_id_fk" FOREIGN KEY ("value_id") REFERENCES "public"."product_option_values"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_products_v_version_variants_options" ADD CONSTRAINT "_products_v_version_variants_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v_version_variants"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_version_categories" ADD CONSTRAINT "_products_v_version_categories_category_id_product_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."product_categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_products_v" ADD CONSTRAINT "_products_v_version_shop_id_shops_id_fk" FOREIGN KEY ("version_shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_rels" ADD CONSTRAINT "_products_v_rels_product_option_values_fk" FOREIGN KEY ("product_option_values_id") REFERENCES "public"."product_option_values"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages" ADD CONSTRAINT "pages_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v" ADD CONSTRAINT "_pages_v_version_shop_id_shops_id_fk" FOREIGN KEY ("version_shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "product_categories" ADD CONSTRAINT "product_categories_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "orders_items_options" ADD CONSTRAINT "orders_items_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."orders_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "orders_items" ADD CONSTRAINT "orders_items_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "orders_items" ADD CONSTRAINT "orders_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "orders" ADD CONSTRAINT "orders_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "orders" ADD CONSTRAINT "orders_customer_id_users_id_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "orders" ADD CONSTRAINT "orders_shipping_address_address_id_addresses_id_fk" FOREIGN KEY ("shipping_address_address_id") REFERENCES "public"."addresses"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "product_options" ADD CONSTRAINT "product_options_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "product_option_values" ADD CONSTRAINT "product_option_values_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "product_option_values" ADD CONSTRAINT "product_option_values_product_option_type_id_product_options_id_fk" FOREIGN KEY ("product_option_type_id") REFERENCES "public"."product_options"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "media" ADD CONSTRAINT "media_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "transactions" ADD CONSTRAINT "transactions_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "addresses" ADD CONSTRAINT "addresses_user_id_customers_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."customers"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "posts" ADD CONSTRAINT "posts_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v" ADD CONSTRAINT "_posts_v_version_shop_id_shops_id_fk" FOREIGN KEY ("version_shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "categories" ADD CONSTRAINT "categories_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "categories" ADD CONSTRAINT "categories_parent_id_categories_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "users_roles" ADD CONSTRAINT "users_roles_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "users_shops" ADD CONSTRAINT "users_shops_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "users_shops" ADD CONSTRAINT "users_shops_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "users_sessions" ADD CONSTRAINT "users_sessions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "header_nav_items" ADD CONSTRAINT "header_nav_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."header"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "header" ADD CONSTRAINT "header_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "header_rels" ADD CONSTRAINT "header_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."header"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "header_rels" ADD CONSTRAINT "header_rels_pages_fk" FOREIGN KEY ("pages_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "header_rels" ADD CONSTRAINT "header_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_nav_items" ADD CONSTRAINT "footer_nav_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer" ADD CONSTRAINT "footer_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "footer_rels" ADD CONSTRAINT "footer_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_rels" ADD CONSTRAINT "footer_rels_pages_fk" FOREIGN KEY ("pages_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_rels" ADD CONSTRAINT "footer_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payment_providers" ADD CONSTRAINT "payment_providers_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "shop_layout" ADD CONSTRAINT "shop_layout_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "shop_settings" ADD CONSTRAINT "shop_settings_shop_id_shops_id_fk" FOREIGN KEY ("shop_id") REFERENCES "public"."shops"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_product_options_fk" FOREIGN KEY ("product_options_id") REFERENCES "public"."product_options"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_product_option_values_fk" FOREIGN KEY ("product_option_values_id") REFERENCES "public"."product_option_values"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_payment_providers_fk" FOREIGN KEY ("payment_providers_id") REFERENCES "public"."payment_providers"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_shop_layout_fk" FOREIGN KEY ("shop_layout_id") REFERENCES "public"."shop_layout"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_shop_settings_fk" FOREIGN KEY ("shop_settings_id") REFERENCES "public"."shop_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "products_options_type_idx" ON "products_options" USING btree ("type_id");
  ...
  CREATE INDEX "products_variants_options_type_idx" ON "products_variants_options" USING btree ("type_id");
  CREATE INDEX "products_variants_options_value_idx" ON "products_variants_options" USING btree ("value_id");
  ...
  CREATE INDEX "products_variants_pricing_pricing_value_idx" ON "products_variants" USING btree ("pricing_value");
  ...
  CREATE INDEX "products_categories_category_idx" ON "products_categories" USING btree ("category_id");
  ...
  CREATE INDEX "products_rels_product_option_values_id_idx" ON "products_rels" USING btree ("product_option_values_id");
  ...
  CREATE INDEX "_products_v_version_options_type_idx" ON "_products_v_version_options" USING btree ("type_id");
  CREATE INDEX "_products_v_version_variants_options_order_idx" ON "_products_v_version_variants_options" USING btree ("_order");
  CREATE INDEX "_products_v_version_variants_options_parent_id_idx" ON "_products_v_version_variants_options" USING btree ("_parent_id");
  CREATE INDEX "_products_v_version_variants_options_type_idx" ON "_products_v_version_variants_options" USING btree ("type_id");
  CREATE INDEX "_products_v_version_variants_options_value_idx" ON "_products_v_version_variants_options" USING btree ("value_id");
  ...
  CREATE INDEX "_products_v_version_variants_pricing_pricing_value_idx" ON "_products_v_version_variants" USING btree ("pricing_value");
  ...
  CREATE INDEX "_products_v_version_categories_category_idx" ON "_products_v_version_categories" USING btree ("category_id");
  CREATE INDEX "_products_v_parent_idx" ON "_products_v" USING btree ("parent_id");
  CREATE INDEX "_products_v_version_version_shop_idx" ON "_products_v" USING btree ("version_shop_id");
  ...
  CREATE INDEX "_products_v_rels_product_option_values_id_idx" ON "_products_v_rels" USING btree ("product_option_values_id");
  ...
  CREATE INDEX "pages_shop_idx" ON "pages" USING btree ("shop_id");
  ...
  CREATE INDEX "_pages_v_version_version_shop_idx" ON "_pages_v" USING btree ("version_shop_id");
  ...
  CREATE INDEX "product_categories_shop_idx" ON "product_categories" USING btree ("shop_id");
  ...
  CREATE INDEX "orders_items_options_order_idx" ON "orders_items_options" USING btree ("_order");
  CREATE INDEX "orders_items_options_parent_id_idx" ON "orders_items_options" USING btree ("_parent_id");
  CREATE INDEX "orders_items_order_idx" ON "orders_items" USING btree ("_order");
  CREATE INDEX "orders_items_parent_id_idx" ON "orders_items" USING btree ("_parent_id");
  CREATE INDEX "orders_items_pricing_pricing_value_idx" ON "orders_items" USING btree ("pricing_value");
  CREATE INDEX "orders_items_image_idx" ON "orders_items" USING btree ("image_id");
  CREATE INDEX "orders_shop_idx" ON "orders" USING btree ("shop_id");
  CREATE INDEX "orders_customer_idx" ON "orders" USING btree ("customer_id");
  CREATE INDEX "orders_shipping_address_shipping_address_address_idx" ON "orders" USING btree ("shipping_address_address_id");
  CREATE INDEX "orders_updated_at_idx" ON "orders" USING btree ("updated_at");
  CREATE INDEX "orders_created_at_idx" ON "orders" USING btree ("created_at");
  CREATE INDEX "product_options_shop_idx" ON "product_options" USING btree ("shop_id");
  CREATE INDEX "product_options_updated_at_idx" ON "product_options" USING btree ("updated_at");
  CREATE INDEX "product_options_created_at_idx" ON "product_options" USING btree ("created_at");
  CREATE INDEX "product_option_values__productoptionvalues_values_order_idx" ON "product_option_values" USING btree ("_productoptionvalues_values_order");
  CREATE INDEX "product_option_values_shop_idx" ON "product_option_values" USING btree ("shop_id");
  CREATE INDEX "product_option_values_product_option_type_idx" ON "product_option_values" USING btree ("product_option_type_id");
  CREATE INDEX "product_option_values_updated_at_idx" ON "product_option_values" USING btree ("updated_at");
  CREATE INDEX "product_option_values_created_at_idx" ON "product_option_values" USING btree ("created_at");
  CREATE INDEX "media_shop_idx" ON "media" USING btree ("shop_id");
  ...
  CREATE UNIQUE INDEX "transactions_provider_transaction_id_idx" ON "transactions" USING btree ("provider_transaction_id");
  ...
  CREATE INDEX "posts_shop_idx" ON "posts" USING btree ("shop_id");
  ...
  CREATE INDEX "_posts_v_version_version_shop_idx" ON "_posts_v" USING btree ("version_shop_id");
  ...
  CREATE INDEX "categories_shop_idx" ON "categories" USING btree ("shop_id");
  CREATE INDEX "categories_slug_idx" ON "categories" USING btree ("slug");
  CREATE INDEX "categories_parent_idx" ON "categories" USING btree ("parent_id");
  CREATE INDEX "categories_updated_at_idx" ON "categories" USING btree ("updated_at");
  CREATE INDEX "categories_created_at_idx" ON "categories" USING btree ("created_at");
  CREATE UNIQUE INDEX "shops_domain_idx" ON "shops" USING btree ("domain");
  CREATE INDEX "shops_allow_public_read_idx" ON "shops" USING btree ("allow_public_read");
  ...
  CREATE INDEX "users_shops_order_idx" ON "users_shops" USING btree ("_order");
  CREATE INDEX "users_shops_parent_id_idx" ON "users_shops" USING btree ("_parent_id");
  CREATE INDEX "users_shops_shop_idx" ON "users_shops" USING btree ("shop_id");
  ...
  CREATE UNIQUE INDEX "header_shop_idx" ON "header" USING btree ("shop_id");
  ...
  CREATE UNIQUE INDEX "footer_shop_idx" ON "footer" USING btree ("shop_id");
  ...
  CREATE UNIQUE INDEX "payment_providers_shop_idx" ON "payment_providers" USING btree ("shop_id");
  CREATE INDEX "payment_providers_updated_at_idx" ON "payment_providers" USING btree ("updated_at");
  CREATE INDEX "payment_providers_created_at_idx" ON "payment_providers" USING btree ("created_at");
  CREATE UNIQUE INDEX "shop_layout_shop_idx" ON "shop_layout" USING btree ("shop_id");
  CREATE INDEX "shop_layout_updated_at_idx" ON "shop_layout" USING btree ("updated_at");
  CREATE INDEX "shop_layout_created_at_idx" ON "shop_layout" USING btree ("created_at");
  ...
  CREATE UNIQUE INDEX "shop_settings_shop_idx" ON "shop_settings" USING btree ("shop_id");
  CREATE INDEX "shop_settings_updated_at_idx" ON "shop_settings" USING btree ("updated_at");
  CREATE INDEX "shop_settings_created_at_idx" ON "shop_settings" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_product_options_id_idx" ON "payload_locked_documents_rels" USING btree ("product_options_id");
  CREATE INDEX "payload_locked_documents_rels_product_option_values_id_idx" ON "payload_locked_documents_rels" USING btree ("product_option_values_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_payment_providers_id_idx" ON "payload_locked_documents_rels" USING btree ("payment_providers_id");
  CREATE INDEX "payload_locked_documents_rels_shop_layout_id_idx" ON "payload_locked_documents_rels" USING btree ("shop_layout_id");
  CREATE INDEX "payload_locked_documents_rels_shop_settings_id_idx" ON "payload_locked_documents_rels" USING btree ("shop_settings_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "orders_items_options" CASCADE;
  DROP TABLE "orders_items" CASCADE;
  DROP TABLE "orders" CASCADE;
  DROP TABLE "product_options" CASCADE;
  DROP TABLE "product_option_values" CASCADE;
  ...
  DROP TABLE "users_shops" CASCADE;
  ...
  DROP TABLE "payment_providers" CASCADE;
  ...
  DROP TYPE "public"."enum_orders_shipping_address_province";
  DROP TYPE "public"."enum_orders_status";
  DROP TYPE "public"."enum_orders_payment_status";
  DROP TYPE "public"."enum_product_options_type";
  DROP TYPE "public"."enum_transactions_status";
  DROP TYPE "public"."enum_addresses_province";

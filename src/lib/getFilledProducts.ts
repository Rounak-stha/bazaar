  ...
  const filledProducts = products.flatMap((product) => {
        ...
        ? [
            {
              ...product,
              image:
                typeof product.Content.images[0] !== 'string' ? product.Content.images[0] : null,
              slug: product.slug,
    ...
    return product.variants
      ...
      .map((variant) => {
        ...
        return {
          ...product,
          image: typeof product.Content.images[0] !== 'string' ? product.Content.images[0] : null,
          slug: product.slug,
          enableVariantPrices: product.enableVariantPrices,
          variant: {
            ...variant,
...
export type FilledProduct = ReturnType<
  typeof getFilledProducts<CartProduct | WishlistProduct>
>[number]

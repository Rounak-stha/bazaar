...
type WishListState = {
  ...
  setWishList: (wishlistToSet: WishList) => void
...
// ToDo Debounce
const debouncedFetchWishListFromUserAccount = fetchWishListFromUserAccount

const debouncedSaveWishListToUserAccount = saveWishListToUserAccount

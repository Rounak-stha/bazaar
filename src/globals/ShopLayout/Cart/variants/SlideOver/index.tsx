...
import { type FilledVariant } from '@/globals/ShopLayout/ProductDetails/types'
  ...
  const fetchCartProducts = useCallback(
    async (cartToCalculate: Cart | null) => {
      try {
        ...
        }>('/next/cartProducts', { cart: cartToCalculate })
        const productsWithTotal = data.productsWithTotal
        const filledProducts = productsWithTotal ? productsWithTotal.filledProducts : []
        const total = productsWithTotal ? productsWithTotal.total : []
            ...
            <DialogContent>
              <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                ...
                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                  ...
                  <p className="mt-1 text-sm text-gray-500">subtotal-info</p>
                  <div className="mt-6">
                    <Link
                      href="/checkout"
                      onClick={() => setCartState(false)}

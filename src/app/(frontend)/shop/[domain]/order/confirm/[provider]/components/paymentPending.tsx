...
export function PaymentPending({ order }: { order: Order | null }) {
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Payment Pendng</h1>
          <p className="text-muted-foreground text-lg">Pease contact our support team.</p>
        </div>

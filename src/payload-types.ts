...
export interface Page {
  ...
  layout: (CallToActionBlock | CarouselBlock | ContentBlock | MediaBlock | ArchiveBlock | FormBlock)[];
  meta?: {
    title?: string | null;
    /**
...
export interface User {
  id: string;
  name?: string | null;
  roles?: ('super-admin' | 'shop-admin')[] | null;
  shops?:
    | {
        shop: string | Shop;
        id?: string | null;
...
export interface ProductOptionValuesSelect<T extends boolean = true> {
  _productOptionValues_values_order?: T;
  shop?: T;
  productOptionType?: T;
  name?: T;
  updatedAt?: T;

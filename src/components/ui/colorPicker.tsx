          ...
          {!showPicker ? (
            ...
            >
              {colors.map((colorItem) => {
                ...
                return (
                  <Button
                    ...
                    className={cn(
                      'overflow-hidden rounded border transition-transform hover:scale-105',
                      color === colorValue
                        ? 'border-payload-elevation-900'
                        : 'border-payload-elevation-150',
                      isGridView
                        ? 'aspect-square h-auto w-full p-0'
              ...
              <button
                onClick={handleReset}
                className={cn(
                  'border-payload-elevation-150 overflow-hidden rounded border transition-all hover:scale-105',
